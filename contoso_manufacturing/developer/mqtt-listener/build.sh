...
sudo docker run -e MQTT_BROKER="10.211.55.5" -e MQTT_TOPIC1="topic/productionline" -e MQTT_TOPIC2="topic/magnemotion" -e INFLUX_URL="http://10.211.55.5:8086" -e INFLUX_TOKEN="secret-token" -e INFLUX_ORG="InfluxData" -e INFLUX_BUCKET="manufacturing" -it agoraarmbladev.azurecr.io/mqtt-listener:latest